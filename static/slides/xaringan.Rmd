...
1. Aligning all content with the `class` slide property ([demo slide](#fullalign-demo))
...
1. [Edit your YAML](#highlightjs-demo) to include a `highlightStyle`, and set `highlightLines` to true.

1. Add a table ([demo slides](#table-demos))

1. Add a plot with decent resolution ([demo slide](#plot-demo))

1. Highlight some lines of R input/output ([demo slide](#highlightr-demo))
...
Throw some [acid](#acid) on your slides with images. Consider:
