...
````
```{r}`r ''`
knitr::include_graphics("http://bit.ly/arm-greens") # url
knitr::include_graphics("img/arm-greens.jpg") # local
```
````
]
...
In your browser, see the `...html#138` at the end? Make it `...html#skip`!
