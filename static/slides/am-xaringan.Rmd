...
.footnote[
You'll make this slide in our first hands-on activity!
]
...
```{r ref.label='alison-plot', dpi = 200, echo = FALSE}
```
]
...
```{r ref.label='alison-plot', echo = FALSE, dpi = 200, out.width = '60%'}
```
]
