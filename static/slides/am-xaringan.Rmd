...
Season some awesome slides with `reveal.js` salt. Make at least one slide that uses each of the following:
...
```{r alison-plot, echo = FALSE, dpi = 180, out.width = '60%'}
```
]
...
+ look at my CSS file to figure out how to change the code highlight color
